...
/*
 * DAP USB backend with command queue (CMSIS-DAP Queue Commands).
 * Based on dap_backend_usb.c and CMSIS-DAP USBD_User_CustomClass_0.c.
 * See: https://arm-software.github.io/CMSIS_5/latest/DAP/html/group__DAP__QueueCommands__gr.html
 */
